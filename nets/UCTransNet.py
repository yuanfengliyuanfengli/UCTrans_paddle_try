...
class UpBlock_attention(nn.Layer):
    def __init__(self, in_channels, out_channels, nb_Conv, activation='ReLU'):
        super().__init__()
    ...
    def forward(self, x, skip_x):
        ...
        x = paddle.concat([skip_x_att, up], axis=1)  # dim 1 is the channel dimension
        return self.nConvs(x)

class UCTransNet(nn.Layer):
